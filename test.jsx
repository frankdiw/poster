    ...
    >
      ...
      <div
        style={{
          ...
          borderRadius: 4,
          background:
            'linear-gradient(180deg,hsla(0,0%,100%,.56),rgba(231,239,251,.35))',
      ...
      >
        ...
        >
          ...
          <div style={{ flex: 1 }}>
            <div style={{ height: 22, fontSize: 12 }}>菜菜的后端私房菜</div>
          </div>
        </div>
        <div
          style={{
        ...
        >
          ...
          <div style={{ height: 50, flex: 1 }}>
            <div style={{ lineHeight: 20, fontSize: 12, color: '#4b5b76' }}>
              长按二维码阅读全文
            </div>
            <div
              style={{
